...
export class PackageController {
  ...
  async getUpcomingPackages(req: Request, res: Response): Promise<void> {
    ...
    const filters: Omit<BrowsePackagesRequestDTO, "startDate" | "endDate"> = {
      ...
      sortKey: req.query.sortKey ? (String(req.query.sortKey) as BrowsePackagesRequestDTO["sortKey"]) : undefined,
      sortBy: (req.query.sortBy as string) || "basePrice",
      sortOrder: req.query.sortOrder === "desc" ? SortOrder.DESC : SortOrder.ASC,
      page,
      limit,
    ...
    ResponseHelper.success(res, HTTP_STATUS.OK, "Upcoming packages retrieved successfully", result);
  }
}
